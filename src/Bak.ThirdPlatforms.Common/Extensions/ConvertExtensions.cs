...
namespace Bak.ThirdPlatforms.Common.Extensions
{
    public static class ConvertExtensions
    {
        ...
        /// <returns></returns>
        public static DateTime TryToDateTimeByTimestamp(this string timestamp)
        {
        ...
        /// <returns></returns>
        public static IEnumerable<EnumModel> TryToList(this Type type)
        {
            var result = new List<EnumModel>();

            foreach (var item in Enum.GetValues(type))
            {
                var response = new EnumModel
                {
                    Key = item.ToString(),
